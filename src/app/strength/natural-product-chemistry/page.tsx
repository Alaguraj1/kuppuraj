      ...
      >
        ...
        >
          ...
          <UnorderedList color="white" pt={3}>
            <ListItem>Extraction of plant constituents</ListItem>
            <ListItem>Isolation of active phytoconstituents</ListItem>
            <ListItem>
              Characterization of phytoconstituents using sophisticated
              instruments such as RP-HPLC, UHPLC, GC-MS and UPLC-QqQ –MS/MS
            </ListItem>
            <ListItem>
              Standardization and quality control of medicinal
              plants/formulations
            </ListItem>
            <ListItem>Validation of raw drugs</ListItem>
            <ListItem>
              Molecular interaction analysis of phytoconstituents on cancer
              receptors by in <i>silico</i> methods
            </ListItem>
            <ListItem>
              Drug Binding properties of phytoconstituent on Human serum albumin
            </ListItem>
          </UnorderedList>
        </Container>
      </Box>
