      ...
      >
        ...
        >
          ...
          <UnorderedList color="white" pt={3}>
            <ListItem>
              Process development of existing drug candidates using cost
              effective synthetic methods
            </ListItem>

            <ListItem>
              Production of bioorganic/biosynthetic compounds using microbes and
              natural flora/fermentation
            </ListItem>
            <ListItem>Scale up of process from small to pilot</ListItem>
            <ListItem>Synthesis of fine chemicals</ListItem>
          </UnorderedList>
        </Container>
      </Box>
