      ...
      >
        ...
        >
          ...
          <UnorderedList color="white" pt={3}>
            <ListItem>
              Analytical method development and validation for API
            </ListItem>
            <ListItem>
              Analytical method development and validation for biological
              products
            </ListItem>
            <ListItem>
              Analytical method development and validation for pharmaceuticals
              and nutraceuticals
            </ListItem>
            <ListItem>Quality by Design (QbD) approach</ListItem>
            <ListItem>
              Evaluation of finished pharmaceuticals and nutraceuticals
            </ListItem>
            <ListItem>Spectral studies (UV, FTIR, NMR, Mass)</ListItem>
          </UnorderedList>
        </Container>
      </Box>
        ...
        <Box p={2}>
          <Box p={2}>
            ...
            <Text fontSize={"lg"} pb="5" textAlign={"justify"}>
              ...
              characterized and identified using techniques like HPLC, MS, and
              NMR.
            </Text>
            <Text fontSize={"lg"} pb="5" textAlign={"justify"}>
