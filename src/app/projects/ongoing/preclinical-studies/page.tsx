      ...
      >
        ...
        >
          ...
          <UnorderedList pt={3} color="white">
            <ListItem>
              Screening of natural compounds for EGFR tyrosine kinase inhibition
              activities in human cervical and pancreatic cancer cells
            </ListItem>

            <ListItem>
              Assessing the therapeutic efficacy of plumbagin and afatinib on
              the expression pattern of epithelial mesenchymal markers and
              migration of EGF-induced cervical cancer cells <i>in vitro</i> and{" "}
              <i>in vivo</i>
            </ListItem>

            <ListItem>
              Does beta-galactosidase isolated from Aspergillus terreus is
              effective in inducing senescence, apoptosis and reducing migration
              of hormone dependent and hormone independent breast cancer cells{" "}
              <i>in vitro</i>?
            </ListItem>
          </UnorderedList>
        </Container>
